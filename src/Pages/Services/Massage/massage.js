        ...
        <div className='facials-section'>
            <div className="bg-image-se">
                ...
                <div className="container">
                    ...
                    <div className="cation-navigation"><Link to={"/"}><span id='home-nav'>Home</span></Link> <span className='facials-caption'>Message</span></div>
                </div>
            </div>
                ...
                <div className="left">
                    <div className="facial-services-list">
                        <ul>
                            ...
                            <li className='service-1 activeted'><Link className='d-flex justify-content-between fs-6 fw-semibold' to={"/services/massage"}><div className='services-sec-name'>Massage</div><div className='arrow-icon active-arrow-icon'><FaArrowRight/></div></Link></li>
