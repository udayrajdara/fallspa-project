        ...
        <div className='facials-section'>
            <div className="bg-image-se">
                ...
                <div className="container">
                    ...
                    <div className="cation-navigation"><Link to={"/"}><span id='home-nav'>Home</span></Link> <span className='facials-caption'>Body Treatment</span></div>
                </div>
            </div>
                ...
                <div className="left">
                    <div className="facial-services-list">
                        <ul>
                            ...
                            <li className='service-1 activeted'><Link className='d-flex justify-content-between fs-6 fw-semibold' to={"/services/bodyTreatment"}><div className='services-sec-name'>Body Treatment</div><div className='arrow-icon active-arrow-icon'><FaArrowRight/></div></Link></li>
