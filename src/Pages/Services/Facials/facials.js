        ...
        <div className='facials-section'>
            <div className="bg-image-se">
                ...
                <div className="container">
                    ...
                    <div className="cation-navigation"><Link to={"/"}><span id='home-nav'>Home</span></Link> <span className='facials-caption'>Facials</span></div>
                </div>
            </div>
            ...
            <div className="facials-best-services d-flex justify-content-center pt-5 align-items-top">
                <div className="left">
                    <div className="facial-services-list">
                        <ul>
                            <li className='service-1 activeted'><Link to={"/services/facials"} className='d-flex justify-content-between fs-6 fw-semibold'><div className='services-sec-name'>Facials</div><div className='arrow-icon active-arrow-icon'><FaArrowRight/></div></Link></li>
